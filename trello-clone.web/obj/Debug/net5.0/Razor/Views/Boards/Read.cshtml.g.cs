#pragma checksum "E:\.NET\API\trello-clone-solution\trello-clone.web\Views\Boards\Read.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2c59727f83056e7ca415c9a946b829a855985d05"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2c59727f83056e7ca415c9a946b829a855985d05", @"/Views/Boards/Read.cshtml")]
...
<script type=""text/javascript"">
    ...
    class todoList {
        ...
        addToDo() {
            ...
            var cardPromise = createCardFetch(this.id, { ""name"": text });
            var cardId = """";
            cardPromise.then(x => {cardId = x.id});
            this.cardArray.push(new Card(text, cardId, this.div, this));
        }
        ...
        createToDoListElement() {
            ...
            this.todoLis");
            WriteLiteral(@"tElement.append(this.h2);
    ...
    class Card {
        ...
        showMenu() {
            ...
            this.menuDescription = document.cr");
            ...
            this.sideRight.innerText = 'Move card';
    ...
    class EditableText {
        constructor(text, place, card, property, typeOfInput, typeOfEdit = """") {
            ...
            this.typeO");
            WriteLiteral(@"fInput = typeOfInput;
        ...
        showEditableTextArea() {
            ...
            this.saveButton.addEventListener('click', () => {
                ...
                this");
            WriteLiteral(@".card.state[this.property] = this.input.value;
            ...
            this.input.addEventListener(""keyup"", (e) => {
                if (this.typeOfInput == ""input"") {
                    clickSaveButton(e, this, this.typeOfEdi");
            WriteLiteral(@"t, this.card.id, this.input.value);
                }
            });
...
#nullable restore
#line 499 "E:\.NET\API\trello-clone-solution\trello-clone.web\Views\Boards\Read.cshtml"
                                                                         Write(token);
...
#nullable restore
#line 509 "E:\.NET\API\trello-clone-solution\trello-clone.web\Views\Boards\Read.cshtml"
                                                                   Write(token);
...
#nullable restore
#line 547 "E:\.NET\API\trello-clone-solution\trello-clone.web\Views\Boards\Read.cshtml"
                                                                                                                        Write(token);
...
#nullable restore
#line 563 "E:\.NET\API\trello-clone-solution\trello-clone.web\Views\Boards\Read.cshtml"
                                                             Write(token);
...
#nullable disable
    ...
    async function updateCardAsync(cardId, card) {
        var url = API_URL + ""/api/cards/"" + cardId + ""?Token="" + """);
#nullable restore
#line 573 "E:\.NET\API\trello-clone-solution\trello-clone.web\Views\Boards\Read.cshtml"
                                                             Write(token);
