#pragma checksum "E:\.NET\API\trello-clone-solution\trello-clone.web\Views\Boards\Read.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7aaf3737464a7dbb813449893abf00c43dd54856"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7aaf3737464a7dbb813449893abf00c43dd54856", @"/Views/Boards/Read.cshtml")]
...
#nullable restore
#line 16 "E:\.NET\API\trello-clone-solution\trello-clone.web\Views\Boards\Read.cshtml"
                          Write(bgImg);
...
#nullable restore
#line 187 "E:\.NET\API\trello-clone-solution\trello-clone.web\Views\Boards\Read.cshtml"
WriteAttributeValue("", 3551, ViewBag.ListsOfBoard, 3551, 21, false);
...
<script type=""text/javascript"">
    ...
    class todoList {
        ...
        addToDo() {
            ...
            var card = createCardFetch(this.id, {""name"" : text});
        ...
        createToDoListElement() {
            ...
            this.input = docu");
            WriteLiteral(@"ment.createElement('input');
            ...
            th");
            WriteLiteral(@"is.todoListElement.id = this.id;
        }
    }
    ...
    class Card {
        ...
        render() {
            ...
            this.d");
            WriteLiteral(@"eleteButton.addEventListener('click', () => {
        ...
        showMenu() {
            ...
            //Add class names
       ");
            WriteLiteral(@"     this.menu.className = ""menu"";
            ...
            this.commentsButton.addEventListener('click', () => {
                if (this.commentsInput.value != """") {
                    this.state.comment");
            WriteLiteral(@"s.push(this.commentsInput.value);
                    this.renderComments();
        ...
        renderComments() {
            ...
            currentCommentsDOM.forEach(comm");
            WriteLiteral(@"entDOM => {
                commentDOM.remove();
            });
...
");
#nullable restore
#line 476 "E:\.NET\API\trello-clone-solution\trello-clone.web\Views\Boards\Read.cshtml"
...
#nullable restore
#line 481 "E:\.NET\API\trello-clone-solution\trello-clone.web\Views\Boards\Read.cshtml"
                                        Write(boardId);
...
#nullable restore
#line 482 "E:\.NET\API\trello-clone-solution\trello-clone.web\Views\Boards\Read.cshtml"
                                                                         Write(token);
...
#nullable restore
#line 492 "E:\.NET\API\trello-clone-solution\trello-clone.web\Views\Boards\Read.cshtml"
                                                                   Write(token);
...
// NEED to FIX it and fix create card API
    async function createCardFetch(listId, card) {
        var url = API_URL + ""/api/cards/listid="" + listId + ""?Token="" + """);
#nullable restore
#line 515 "E:\.NET\API\trello-clone-solution\trello-clone.web\Views\Boards\Read.cshtml"
                                                                    Write(token);
...
#nullable restore
#line 527 "E:\.NET\API\trello-clone-solution\trello-clone.web\Views\Boards\Read.cshtml"
                                                             Write(token);
...
#nullable disable
    ...
    async function updateCardAsync(cardId, card) {
        var url = API_URL + ""/api/cards/"" + cardId + ""?Token="" + """);
#nullable restore
#line 537 "E:\.NET\API\trello-clone-solution\trello-clone.web\Views\Boards\Read.cshtml"
                                                             Write(token);
